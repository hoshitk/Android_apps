...
public class DiaryRealmAdapter extends RealmRecyclerViewAdapter<Diary, DiaryRealmAdapter.DiaryViewHolder> {
    ...
    @NonNull
    @Override
    public DiaryRealmAdapter.DiaryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DiaryRealmAdapter.DiaryViewHolder holder, int position) {
        Diary diary = getData().get(position);
