package com.example.myclockwidget;
...
public class MyClockWidget extends AppWidgetProvider {
    ...
    private void deleteAlarm(Context context, Intent intent) {
        ...
        if (appWidgetId != AppWidgetManager.INVALID_APPWIDGET_ID) {
            ...
            alarmManager.cancel(PendingIntent.getBroadcast(context,
                    0, buildAlarmIntent(context, appWidgetId), PendingIntent.FLAG_UPDATE_CURRENT));
        }
    }
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.my_clock_widget);
